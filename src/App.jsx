...
const externalLinks = {
  ...
  Roblox:
    "https://create.roblox.com/docs/pt-br/production/publishing/publish-games-and-places#publicar-jogos",
  "Comunidade no Discord": "https://discord.gg/Kvh3ccfrM8",
  "Guia para pais e educadores":
    "https://docs.google.com/document/d/e/2PACX-1vSiAvmcWNoNZUDhSlYMYeFnbKm0W-irUtdpwT0-zs1Jzp2OIA4rNEka9m9hSqD3Eu6w0UxHgIqbrkbq/pub",
};
...
const ACHIEVEMENTS = [
  { id: "creator", kind: "symbol", symbol: "badge-creator", frame: "circle" },
  {
    id: "constructor",
    kind: "symbol",
    symbol: "badge-creator-construtor",
    frame: "circle",
  },
  {
    id: "tut-3d",
    kind: "symbol",
    symbol: "badge-construtor-3d",
    frame: "circle",
  },
  {
    id: "tut-plataforma",
    kind: "symbol",
    symbol: "badge-plataforma-some",
    frame: "circle",
  },
  {
    id: "tut-porta",
    kind: "symbol",
    symbol: "badge-porta-automatica",
    frame: "circle",
  },
  {
    id: "tut-moeda",
    kind: "symbol",
    symbol: "badge-moeda-magica",
    frame: "circle",
  },
  {
    id: "tut-clicker",
    kind: "symbol",
    symbol: "badge-clicker-meta",
    frame: "circle",
  },
  {
    id: "tut-semaforo",
    kind: "symbol",
    symbol: "badge-semaforo",
    frame: "circle",
  },
  {
    id: "bilde-game",
    kind: "symbol",
    symbol: "badge-jogo-ia",
    frame: "circle",
  },
];
...
const CONTEXT_RAIL = {
  expedition: {
    ...
    intro:
      "A Expedição ganha forma em encontros, ativações, creators convidados, famílias presentes e caminhos que continuam depois de cada parada.",
    highlight: {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            title:
              "Imprensa, governo e parceiros certos mudam o peso do encontro",
    ...
    cards: [
      ...
      },
      {
        ...
        title:
          "Quando famílias veem o processo, a confiança deixa de ser abstrata",
      ...
      },
      {
        ...
        title:
          "Camps, materiais e desafios já aparecem como próximos desdobramentos",
  ...
  ecosystem: {
    ...
    intro:
      "Aqui a ideia não é explicar ferramenta por ferramenta. É mostrar o tipo de criação, continuidade e repertório que esse ecossistema pode colocar nas mãos de quem entra nele.",
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            kicker: "Brasília",
            title:
              "Primeval Earth virou referência concreta de onde se pode chegar",
  ...
  parents: {
    ...
    intro:
      "Aqui aparecem sinais concretos de cuidado, mediação e aprendizagem para quem acompanha adolescentes criando no universo Roblox.",
    sections: [
      {
  ...
  journeyGuest: {
    ...
    intro:
      "Quando o creator entra, esta coluna passa a mostrar badges, passos concluídos e o que faz sentido explorar em seguida.",
    cards: [
      {
        icon: "target",
        kicker: "Progresso",
...
const CONTEXT_RAIL_I18N = {
  ...
  en: {
    expedition: {
      ...
      intro:
        "The Expedition takes shape through meetups, activations, invited creators, families on site and paths that continue after each stop.",
      highlight: {
        kicker: "São Paulo · Rio · Brasília · gamescom",
          ...
          items: [
            {
              ...
              image: {
                src: "/context-rail/rio-42.jpg",
                alt: "Roblox Expedition gathering at 42 Rio",
                position: "center 44%",
              },
            },
            {
              ...
              image: {
                src: "/context-rail/sao-paulo-atividade.jpg",
                alt: "Roblox Expedition activity in São Paulo",
                position: "center 42%",
              },
            },
            {
              kicker: "Brasília",
              title:
                "Going to the Center-West expanded the program's legitimacy",
              ...
              image: {
                src: "/context-rail/brasilia-familias.jpg",
                alt: "Conversation with families and participants in Brasília",
                position: "center 42%",
              },
            },
          ],
          ...
          items: [
            {
              ...
              image: {
                src: "/context-rail/gamescom-palco.jpg",
                alt: "Roblox Expedition activation at gamescom latam",
                position: "center 28%",
              },
            },
            {
              ...
              image: {
                src: "/context-rail/sao-paulo-lab.jpg",
                alt: "Young participants in São Paulo",
                position: "center 28%",
              },
            },
            {
              ...
              title:
                "Press, government and the right partners change the weight of the encounter",
              ...
              image: {
                src: "/context-rail/gamescom-palco.jpg",
                alt: "Public moment of Roblox Expedition",
                position: "center 20%",
              },
            },
          ],
      ...
      cards: [
        {
          ...
          image: {
            src: "/context-rail/rio-42.jpg",
            alt: "Young people creating in a guided Expedition activity",
            position: "center 46%",
          },
        },
        {
          ...
          image: {
            src: "/context-rail/brasilia-familias.jpg",
            alt: "Conversation with families in Brasília",
            position: "center 42%",
          },
        },
        {
          ...
          image: {
            src: "/context-rail/sao-paulo-atividade.jpg",
            alt: "Participants continuing to create",
            position: "center 42%",
          },
    ...
    ecosystem: {
      ...
      intro:
        "The point here is not to explain tool by tool. It is to show the kind of creation, continuity and repertoire this ecosystem can put into the hands of whoever enters it.",
      sections: [
        {
          ...
          items: [
            {
              ...
              image: {
                src: "/context-rail/sao-paulo-atividade.jpg",
                alt: "Young people creating in São Paulo",
                position: "center 40%",
              },
            },
            {
              kicker: "Brasília",
              title:
                "Primeval Earth became a concrete reference for what is possible",
              ...
              image: {
                src: "/context-rail/brasilia-familias.jpg",
                alt: "Participants and guests in Brasília",
                position: "center 34%",
              },
            },
          ],
          ...
          items: [
            {
              ...
              image: {
                src: "/context-rail/rio-42.jpg",
                alt: "Expedition activity in Rio",
                position: "center 44%",
              },
            },
            {
              ...
              image: {
                src: "/context-rail/gamescom-palco.jpg",
                alt: "Public Roblox Expedition activation at gamescom",
                position: "center 24%",
              },
            },
          ],
      ...
      cards: [
        ...
        },
        {
          ...
          kicker: "Community",
          title:
            "Between one step and the next, the community keeps the rhythm",
    ...
    parents: {
      ...
      intro:
        "Here you can see concrete signs of care, mediation and learning for anyone following teenagers creating inside the Roblox universe.",
      sections: [
        {
          ...
          items: [
            {
              kicker: "Brasília",
              title:
                "Families were brought into the conversation, not left at the edge",
            ...
            },
            {
              kicker: "São Paulo",
              title:
                "Watching creation happen changes how the program is perceived",
          ...
          items: [
            {
              ...
              image: {
                src: "/context-rail/rio-42.jpg",
                alt: "Expedition activity in Rio de Janeiro",
                position: "center 44%",
              },
            },
            {
              ...
              title:
                "Press and institutional presence make the program easier to read",
              ...
              image: {
                src: "/context-rail/gamescom-palco.jpg",
                alt: "Public moment with Expedition mediation",
                position: "center 22%",
              },
            },
          ],
    ...
    journeyGuest: {
      ...
      intro:
        "Once the creator enters, this column starts showing badges, completed steps and what makes sense to explore next.",
      cards: [
        {
          icon: "target",
          kicker: "Progress",
          title: "Earned badges",
          body: "A memory of program badges, with what has already been reached and what still needs to be unlocked.",
        },
        {
          icon: "stair",
          kicker: "Next step",
          title: "Missions in progress",
          body: "Space for the next step in the journey, with short and actionable guidance.",
        },
        {
          icon: "compass",
          kicker: "Rhythm",
          title: "Your path in the program",
          body: "The column can help the creator understand where they are and what makes sense to explore next.",
        },
      ],
    },
  },
  es: {
    expedition: {
      ...
      intro:
        "La Expedición toma forma en encuentros, activaciones, creators invitados, familias presentes y caminos que continúan después de cada parada.",
      highlight: {
        kicker: "São Paulo · Rio · Brasília · gamescom",
          ...
          items: [
            {
              ...
              image: {
                src: "/context-rail/rio-42.jpg",
                alt: "Encuentro de la Expedición Roblox en 42 Rio",
                position: "center 44%",
              },
            },
            {
              ...
              image: {
                src: "/context-rail/sao-paulo-atividade.jpg",
                alt: "Actividad de la Expedición Roblox en São Paulo",
                position: "center 42%",
              },
            },
            {
              ...
              image: {
                src: "/context-rail/brasilia-familias.jpg",
                alt: "Conversación con familias y participantes en Brasília",
                position: "center 42%",
              },
            },
          ],
          ...
          items: [
            {
              ...
              image: {
                src: "/context-rail/gamescom-palco.jpg",
                alt: "Activación de la Expedición Roblox en gamescom latam",
                position: "center 28%",
              },
            },
            {
              ...
              image: {
                src: "/context-rail/sao-paulo-lab.jpg",
                alt: "Participantes jóvenes en São Paulo",
                position: "center 28%",
              },
            },
            {
              ...
              title:
                "Prensa, gobierno y socios adecuados cambian el peso del encuentro",
              ...
              image: {
                src: "/context-rail/gamescom-palco.jpg",
                alt: "Momento público de la Expedición Roblox",
                position: "center 20%",
              },
            },
          ],
      ...
      cards: [
        {
          ...
          title:
            "La creación guiada da más cuerpo a lo que los jóvenes pueden hacer",
          ...
          image: {
            src: "/context-rail/rio-42.jpg",
            alt: "Jóvenes creando en actividad guiada",
            position: "center 46%",
          },
        },
        {
          ...
          title:
            "Cuando las familias ven el proceso, la confianza deja de ser abstracta",
          ...
          image: {
            src: "/context-rail/brasilia-familias.jpg",
            alt: "Conversación con familias en Brasília",
            position: "center 42%",
          },
        },
        {
          ...
          image: {
            src: "/context-rail/sao-paulo-atividade.jpg",
            alt: "Participantes continuando la creación",
            position: "center 42%",
          },
    ...
    ecosystem: {
      ...
      intro:
        "La idea aquí no es explicar herramienta por herramienta. Es mostrar el tipo de creación, continuidad y repertorio que este ecosistema puede poner en manos de quien entra en él.",
      sections: [
        {
          ...
          items: [
            {
              ...
              image: {
                src: "/context-rail/sao-paulo-atividade.jpg",
                alt: "Jóvenes creando en São Paulo",
                position: "center 40%",
              },
            },
            {
              kicker: "Brasília",
              title:
                "Primeval Earth se volvió una referencia concreta de hasta dónde se puede llegar",
              ...
              image: {
                src: "/context-rail/brasilia-familias.jpg",
                alt: "Participantes e invitados en Brasília",
                position: "center 34%",
              },
            },
          ],
          ...
          items: [
            {
              kicker: "Rio de Janeiro",
              title:
                "Lo que empieza en el evento puede volverse presencia continua",
              ...
              image: {
                src: "/context-rail/rio-42.jpg",
                alt: "Actividad de la Expedición en Río",
                position: "center 44%",
              },
            },
            {
              ...
              image: {
                src: "/context-rail/gamescom-palco.jpg",
                alt: "Activación pública en gamescom",
                position: "center 24%",
              },
            },
          ],
    ...
    parents: {
      ...
      intro:
        "Aquí aparecen señales concretas de cuidado, mediación y aprendizaje para quien acompaña a adolescentes creando dentro del universo Roblox.",
      sections: [
        {
          ...
          items: [
            {
              kicker: "Brasília",
              title:
                "Las familias entraron en la conversación, no quedaron al margen",
              ...
              image: {
                src: "/context-rail/brasilia-familias.jpg",
                alt: "Ronda de conversación con familias en Brasília",
                position: "center 42%",
              },
            },
            {
              kicker: "São Paulo",
              title:
                "Ver la creación ocurriendo cambia la percepción del programa",
              ...
              image: {
                src: "/context-rail/sao-paulo-lab.jpg",
                alt: "Participantes en São Paulo",
                position: "center 32%",
              },
            },
          ],
          ...
          items: [
            {
              kicker: "Rio de Janeiro",
              title:
                "Las alianzas locales dieron base social real al encuentro",
              ...
              image: {
                src: "/context-rail/rio-42.jpg",
                alt: "Actividad de la Expedición en Rio de Janeiro",
                position: "center 44%",
              },
            },
            {
              ...
              title:
                "Prensa y presencia institucional vuelven el programa más legible",
              ...
              image: {
                src: "/context-rail/gamescom-palco.jpg",
                alt: "Momento público con mediación de la Expedición",
                position: "center 22%",
              },
            },
          ],
    ...
    journeyGuest: {
      ...
      title: "¿Cómo voy?",
      intro:
        "Cuando el creator entra, esta columna pasa a mostrar badges, pasos concluidos y lo que tiene sentido explorar después.",
      cards: [
        {
          icon: "target",
          kicker: "Progreso",
          title: "Badges conquistados",
          body: "Memoria de los badges del programa, con lo que ya se alcanzó y lo que aún falta desbloquear.",
        },
        {
          icon: "stair",
          kicker: "Siguiente paso",
          title: "Misiones en curso",
          body: "Espacio para la próxima etapa de la jornada, con orientación corta y accionable.",
        },
        {
          icon: "compass",
          kicker: "Ritmo",
          title: "Tu camino en el programa",
          body: "La columna puede ayudar al creator a entender dónde está y qué vale la pena explorar después.",
        },
      ],
    },
  },
...
function App() {
  const [lang, setLang] = useState(
    () => localStorage.getItem("hublox-lang") || "pt",
  );
  const t = translations[lang] || translations.pt;

  const [creatorSession, setCreatorSession] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem("hublox-creator-session")) || null;
    } catch {
      return null;
    }
  });
  ...
  const [achievements, setAchievements] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem("hublox-achievements")) || {};
    } catch {
      return {};
    }
  });
  const [screen, setScreen] = useState(() =>
    creatorSession ? "hub" : "entry",
  );
  ...
  const [mobileMenuIntroHighlight, setMobileMenuIntroHighlight] =
    useState(null);
  const [logoutConfirmOpen, setLogoutConfirmOpen] = useState(false);
  const [mobileSectionTitleVisible, setMobileSectionTitleVisible] =
    useState(false);
  ...
  useEffect(() => {
    if (creatorSession)
      localStorage.setItem(
        "hublox-creator-session",
        JSON.stringify(creatorSession),
      );
  }, [creatorSession]);

  useEffect(() => {
    if (!creatorSession?.birthday) {
      setUserAge(null);
      return;
    }
  ...
  const markEco = (key, level) =>
    setEcoProgress((prev) =>
      prev[level][key]
        ? prev
        : { ...prev, [level]: { ...prev[level], [key]: true } },
    );
  ...
  useEffect(() => {
    const pendingKeys = ECO_KEYS.filter(
      (k) => ecoProgress.pending[k] && !ecoProgress.done[k],
    );
  ...
  useEffect(() => {
    if (
      ...
      tab !== "jornada" ||
      sub === "main" ||
      !activeJourneyDetailRef.current
    )
      return;
  ...
  const API_URL =
    import.meta.env.VITE_API_URL || "https://roblox-api.mastertech.com.br";
  ...
  async function validateRobloxHandle(handle) {
    ...
    try {
      const res = await fetch(
        `${API_URL}/api/roblox/user/?username=${encodeURIComponent(handle)}`,
      );
      ...
      if (!data.found) {
        setRobloxError(
          t.id.notFound ||
            "Usuário não encontrado no Roblox. Verifique o username.",
        );
        return;
      }
    ...
    try {
      ...
      try {
        const meRes = await fetch(
          `${API_URL}/api/user/me/?roblox_id=${resolvedId}`,
        );
        if (meRes.ok) {
  ...
  const mobileSectionTitle =
    activeNav.find((item) => item.key === tab)?.label || "";
  ...
  const canOpenJourneyDrawer = isMobile && tab === "jornada" && !!journeyDevice;

  const showJourneyMascot = tab === "jornada" && (!isMobile || !!journeyDevice);
  ...
  const cycleLang = () => {
    ...
    const nextIndex =
      currentIndex >= 0 ? (currentIndex + 1) % langOrder.length : 0;
  ...
  const detailProps = (kind) => {
    const map = {
      mob: {
        ...
        actionTheme: "yellow",
        modalLabel: "Studio mobile",
        loopVideo: "/uploads/studiomobile-loop.mp4",
      },
      bilde: {
        accent: palette.red,
        dict: t.detail.bilde,
        actionTheme: "",
        modalLabel: "Roblox Studio",
        loopVideo: "/uploads/bilde-loop.mp4",
      },
      tut: {
        accent: palette.blue,
        dict: t.detail.tut,
        actionTheme: "",
        modalLabel: "Roblox Studio",
        loopVideo: "/uploads/plugin-loop.mp4",
      },
    };
    return map[kind];
  };
  ...
  const heroVideo = isMobile
    ? lang === "en"
      ? "/uploads/manifesto-eng.mp4"
      : "/uploads/manifesto-ptbr.mp4"
    : "/uploads/manifesto-horiz.mp4";

  const ecoExplored = ECO_KEYS.filter(
    (k) =>
      ecoProgress.viewed[k] || ecoProgress.done[k] || ecoProgress.pending[k],
  ).length;
  const ecoDone = ECO_KEYS.filter((k) => ecoProgress.done[k]).length;
  const ecoPending = ECO_KEYS.filter(
    (k) => ecoProgress.pending[k] && !ecoProgress.done[k],
  ).length;
        ...
        return (
          ...
          >
            <div className="sa-cluster-head">
              <h3
                className="sa-cluster-name"
                style={{ color: cluster.style.titleColor }}
              >
                {clusterText.name}
              </h3>
              <span
            ...
            <p
              className="sa-cluster-desc"
              style={{ color: cluster.style.textColor }}
            >
              {clusterText.desc}
            </p>
            <div className="sa-grid">
              {cluster.badgeIds.map((badgeId) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`sa-item ${a.frame} ${earned ? "earned" : "locked"}`}
                    >
                      {!earned && (
                        <span
                          className="sa-lock sa-lock-badge"
                          aria-hidden="true"
                        >
                      ...
                      {a.kind === "symbol" ? (
                        <svg
                          className="sa-badge-svg"
                          viewBox="0 0 120 120"
                          aria-hidden="true"
                        >
                          <use
                            href={`${earned ? badgesCorUrl : badgesLinhaUrl}#${a.symbol}`}
                          />
                        </svg>
                      ) : a.kind === "badge" ? (
                        <img
                          ...
                          alt={label}
                          onError={(e) => {
                            e.currentTarget.src = MEDAL_FALLBACK;
                          }}
                        />
                      ) : (
    ...
    <div className="app-root">
      ...
      {screen === "anamnese" && (
        <section className="entry-shell dark-shell">
          <div className="entry-card">
            <EntryLogos />
            <button className="back-link" onClick={() => setScreen("entry")}>
              {t.common.back}
            </button>
      ...
      {screen === "creator-id" && idStep === "username" && (
        <section className="entry-shell dark-shell">
          <div className="entry-card">
            ...
            <button
              className="back-link"
              onClick={() => runLoading(() => setScreen("entry"))}
            >
              {t.common.back}
            </button>
            ...
            <div className="id-form">
              <div className="id-field">
                <label className="id-label" htmlFor="id-roblox">
                  {t.id.robloxLabel}
                </label>
                <div className="id-input-wrap">
                  ...
                  <input
                    ...
                    value={robloxHandle}
                    onChange={(e) => {
                      setRobloxHandle(e.target.value.replace(/^@+/, ""));
                      setRobloxError("");
                    }}
                    onKeyDown={(e) => {
                      if (e.key === "Enter" && robloxHandle.trim())
                        validateRobloxHandle(robloxHandle.trim());
                    }}
                  />
                </div>
            ...
            <div className="id-confirm-card">
              ...
              <div className="id-confirm-avatar">
                {resolvedThumbnailUrl ? (
                  ...
                  (resolvedDisplayName || resolvedHandle)
                    .charAt(0)
                    .toUpperCase()
                )}
              </div>
              ...
              <div className="id-confirm-actions">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      const res = await fetch(
                        `${API_URL}/api/user/check/?roblox_id=${resolvedId}&roblox_username=${encodeURIComponent(resolvedHandle)}`,
                      );
                      const data = await res.json();
                      if (data.exists) {
                        let displayName = resolvedDisplayName;
                        ...
                        try {
                          ...
                          /* non-blocking: proceed with resolved data */
                        }
                        setCreatorSession({
                          handle: resolvedHandle,
                          displayName,
      ...
      {screen === "creator-id" && idStep === "details" && (
        <section className="entry-shell dark-shell">
          <div className="entry-card">
            <EntryLogos />
            <button className="back-link" onClick={() => setIdStep("confirm")}>
              {t.common.back}
            </button>
            ...
            <div className="id-roblox-preview">
              ...
              <div className="id-roblox-preview-info">
                <span className="id-roblox-preview-display">
                  {resolvedDisplayName}
                </span>
                <span className="id-roblox-preview-handle">
                  @{resolvedHandle}
                </span>
              </div>
            </div>
            ...
            <div className="id-form">
              <div className="id-field">
                <label className="id-label" htmlFor="id-email">
                  {t.id.emailLabel}
                </label>
                <input
                  id="id-email"
              ...
              <div className="id-field">
                <label className="id-label" htmlFor="id-birthday">
                  {t.id.birthdayLabel}
                </label>
                <input
                  id="id-birthday"
              ...
              <div className="id-field">
                <label className="id-label" htmlFor="id-pais">
                  {t.id.countryLabel}
                </label>
                <select
                  id="id-pais"
              ...
              {statesByCountry[pais] && (
                <div className="id-field">
                  <label className="id-label" htmlFor="id-estado">
                    {t.id.stateLabel}
                  </label>
                  <select
                    id="id-estado"
            ...
            >
              <span>
                {registerLoading ? t.id.saving || "Salvando..." : t.id.continue}
              </span>
              <span className="cta-badge">→</span>
            </button>
          </div>
          ...
          <div className="entry-card">
            ...
            <QuestionCard number="01" title={t.creatorQ.q1Title}>
              <div className="pill-row">
                <QuestionPill active={qDev === "pc"} onClick={runPcTest}>
                  {t.creatorQ.optComputer}
                </QuestionPill>
                <QuestionPill active={qDev === "mob"} onClick={chooseMobile}>
                  {t.creatorQ.optMobile}
                </QuestionPill>
              </div>
            </QuestionCard>
            ...
            {qDev === "pc" && pcTest === "running" && (
              <TestingCard
                title={t.creatorQ.testing.title}
                note={t.creatorQ.testing.note}
              />
            )}
                  ...
                  {activeNav.map((item) => (
                    ...
                    >
                      <span className="side-icon">
                        {icon(navIcon(item.key), "rgba(255,255,255,.75)")}
                      </span>
                ...
                <div className="sidebar-footer">
                  {creatorSession && (
                    <div className="sidebar-user">
                      ...
                      <div className="sidebar-user-info">
                        <span className="sidebar-user-display">
                          {creatorSession.displayName || creatorSession.handle}
                        </span>
                  ...
                  >
                    <span className="sidebar-exit-icon">
                      {icon("logout", "rgba(255,255,255,.9)")}
                    </span>
                    <span>
            ...
            <main className="main-panel">
              {welcomeBack && creatorSession && (
                ...
                >
                  <span>
                    ...
                    <strong>@{creatorSession.handle}</strong>
                  </span>
                  <button
              ...
              {isMobile && (
                <>
                  ...
                  />
                  <div
                    className={`mobile-speed-dial ${mobileMenuOpen ? "open" : ""} ${mobileMenuIntroActive ? "intro-active" : ""}`}
                  ...
                  <div
                    className={`mobile-section-sticky-bar ${mobileSectionTitleVisible ? "visible" : ""}`}
                  >
                    <span className="mobile-section-sticky-copy">
                      <span>{mobileSectionTitle}</span>
                      {tab === "jornada" && creatorSession && (
                        <span
                          className="mobile-section-live-indicator"
                          aria-hidden="true"
                        />
                      )}
                    </span>
                ...
                <div className="content-shell" ref={contentShellRef}>
                  ...
                  {tab === "jornada" && journeyView === "inline" && (
                    <section className="journey-page">
                      <div className="journey-page-hero">
                        ...
                        {showJourneyMascot ? (
                          canOpenJourneyDrawer ? (
                            ...
                            >
                              <span className="journey-page-mascot-icon">
                                <LogoMark />
                              </span>
                              <span className="journey-page-mascot-note">
                                {t.journey.mascotFollow}
                              </span>
                            </button>
                          ) : (
                            <div
                              className="journey-page-mascot"
                              aria-hidden="true"
                            >
                              <span className="journey-page-mascot-icon">
                                <LogoMark />
                      ...
                      >
                        ...
                        >
                          <span className="device-switch-icon">
                            {icon(
                              "mobile",
                      ...
                      {journeyDevice && isMobile && (
                        <div
                          className={`journey-mobile-flow ${mobileJourneyStep ? "has-active-step" : ""}`}
                        >
                          {[
                            {
                              id: "1",
                              tag: t.journey.labelMobile,
                              title: `${t.journey.stepLabel} 1`,
                            },
                            {
                              id: "2",
                              tag: t.publish.kicker,
                              title: `${t.journey.stepLabel} 2`,
                            },
                            {
                              id: "3",
                              tag: t.community.kicker,
                              title: `${t.journey.stepLabel} 3`,
                            },
                          ]
                            .filter(
                              (step) =>
                                !mobileJourneyStep ||
                                Number(step.id) <= Number(mobileJourneyStep),
                            )
                            .map((step) => (
                              <div
                                key={step.id}
                              ...
                              >
                                <button
                                  ...
                                  onClick={() => {
                                    setSub("main");
                                    setMobileJourneyStep((prev) =>
                                      prev === step.id ? null : step.id,
                                    );
                                  }}
                                >
                                  <span className="journey-mobile-step-headgroup">
                                    <span className="journey-mobile-step-title">
                                      {step.title}
                                    </span>
                                    <span className="journey-mobile-step-tag">
                                      {step.tag}
                                    </span>
                                  </span>
                                  <span
                                    className="journey-mobile-step-chevron"
                                    aria-hidden="true"
                                  >
                                  ...
                                  <div className="journey-mobile-step-content">
                                    ...
                                    {step.id === "2" && (
                                      <PublishJourneyCard
                                        ...
                                        hideKicker
                                        onClick={() =>
                                          setModal({ label: "Roblox" })
                                        }
                                      />
                                    )}
                                    {step.id === "3" && (
                                      <CommunityJourneyCard
                                        dict={t.community}
                                        hideKicker
                                        onClick={() =>
                                          setModal({
                                ...
                                .map((step) => (
                                  ...
                                  >
                                    <span className="journey-mobile-step-dock-headgroup">
                                      <span className="journey-mobile-step-dock-title">
                                        {step.title}
                                      </span>
                                      <span className="journey-mobile-step-dock-tag">
                                        {step.tag}
                                      </span>
                                    </span>
                                    <span
                                      className="journey-mobile-step-dock-chevron"
                                      aria-hidden="true"
                                    >
                                      ∨
                                    </span>
                      ...
                      {journeyDevice && !isMobile && (
                        <div className="journey-stack">
                            ...
                            <div className="journey-step">
                              ...
                              <div className="journey-node">
                                <JourneyCard
                                  ...
                                  open={sub === "mob"}
                                  onClick={() =>
                                    setSub(sub === "mob" ? "main" : "mob")
                                  }
                                />
                                {sub === "mob" && (
                                  <InlineJourneyDetail
                                    containerRef={activeJourneyDetailRef}
                                  >
                                    {renderDetail("mob", {
                                      inline: true,
                                      onBack: () =>
                                        runSectionLoading(() => setSub("main")),
                                    })}
                                  </InlineJourneyDetail>
                                )}
                              </div>
                          ...
                          <div className="journey-step">
                            <div className="journey-step-label">
                              {t.journey.stepLabel}{" "}
                              {journeyDevice === "computer" ? "4" : "3"}
                            </div>
                            <div className="journey-node">
                              <CommunityJourneyCard
                                dict={t.community}
                                onClick={() =>
                                  setModal({ label: "Comunidade no Discord" })
                                }
                              />
                            </div>
                          </div>
                  ...
                  {tab === "eco" && (
                    <section>
                      ...
                      <EcoProgress
                        explored={ecoExplored}
                        done={ecoDone}
                        pending={ecoPending}
                        total={ECO_KEYS.length}
                        t={t}
                      />
                      ...
                      >
                        ...
                        <div className="ecosystem-cta-area">
                          <div className="ecosystem-cta-copy">
                            {t.eco.studiomob.ctaCopy}
                          </div>
                          <button
                            className="small-action yellow ecosystem-cta-button"
                            onClick={(e) => {
                              e.stopPropagation();
                              runEcoAction("studiomob");
                              setModal({ label: "Studio mobile" });
                            }}
                          >
                            {t.eco.studiomob.cta}
                          </button>
                        ...
                        <div className="nested-cards">
                          ...
                          <SubToolCard
                            ...
                            onToggle={(e) => {
                              e.stopPropagation();
                              setEcoSubOpen(
                                ecoSubOpen === "tutoriais" ? null : "tutoriais",
                              );
                            }}
                      ...
                      >
                        ...
                        <div className="ecosystem-cta-area">
                          <div className="ecosystem-cta-copy">
                            {t.eco.roblox.ctaCopy}
                          </div>
                          <button
                            className="small-action red ecosystem-cta-button"
                            onClick={(e) => {
                              e.stopPropagation();
                              markEco("roblox", "done");
                              setModal({ label: "Roblox" });
                      ...
                      >
                        <InfoRows
                          accent="purple"
                          rows={t.eco.comunidade.rows}
                        />
                        <div className="ecosystem-cta-area">
                          <div className="ecosystem-cta-copy">
                            {t.eco.comunidade.ctaCopy}
                          </div>
                          <button
                            className="small-action purple ecosystem-cta-button discord-cta-button"
                            onClick={(e) => {
                              e.stopPropagation();
                              runEcoAction("comunidade");
                              setModal({ label: "Comunidade no Discord" });
                            }}
                          >
                        ...
                        {t.sobre.sections.map((section, index) => (
                          <div key={index} className="sobre-item">
                            <div className="sobre-icon">
                              {icon(
                                sobreMeta[index].icon,
                                sobreMeta[index].color,
                              )}
                            </div>
                            <div className="sobre-copy">
                              <div
                                className="sobre-kicker"
                                style={{ color: sobreMeta[index].color }}
                              >
                                {section.kicker}
                              </div>
                              {section.paragraphs.map((p, i) => (
                                <p
                                  key={`${index}-${i}`}
                                  className={`sobre-paragraph ${i === 0 ? "lead" : ""}`}
                                >
                                  {p}
                                </p>
                              ))}
                              {expeditionSectionActions[index] && (
                                <div className="sobre-cta-row">
                                  <button
                                    ...
                                    onClick={() =>
                                      openExpeditionSectionModal(
                                        expeditionSectionActions[index],
                                      )
                                    }
                                  >
                                    <span className="sobre-cta-text">
                                      {expeditionSectionActions[index].button}
                                    </span>
                                    <span
                                      className="sobre-cta-arrow"
                                      aria-hidden="true"
                                    >
                                      →
                                    </span>
                  ...
                  {tab === "pais" &&
                    (() => {
                      const aud = audience
                        ? t.responsaveis.audiences[audience]
                        : null;
                      const media = audience
                        ? responsaveisMedia[audience]
                        : null;
                      return (
                        <section>
                          <ReachBadge text={t.common.reach} />
                          <h2 className="page-title">
                            {t.responsaveis.pageTitle}
                          </h2>
                          <p className="page-subtitle wider">
                            {t.responsaveis.pageSubtitle}
                          </p>

                          <div
                            className={`device-switch ${isMobile && audience ? "compact-mobile" : ""}`}
                            role="tablist"
                            aria-label={t.responsaveis.audienceAria}
                          >
                            <button
                            ...
                            >
                              ...
                              <span className="device-switch-copy">
                                <strong>
                                  {t.responsaveis.toggleResp.strong}
                                </strong>
                            ...
                            >
                              ...
                              <span className="device-switch-copy">
                                <strong>
                                  {t.responsaveis.toggleEdu.strong}
                                </strong>
                          ...
                          {aud && (
                            <>
                              ...
                              <div
                                className="resp-group"
                                ref={responsaveisMediaRef}
                              >
                                <div className="resp-section-head">
                                  <span className="resp-section-icon">
                                    {icon("play", palette.red)}
                                  </span>
                                  <h3 className="resp-section-title">
                                    {t.responsaveis.videosLabel}
                                  </h3>
                                </div>
                                  ...
                                  {aud.videos.map((video, i) => (
                                    ...
                                    >
                                      <div className="resp-video-thumb">
                                        <img
                                          src={`https://img.youtube.com/vi/${media.videos[i]}/hqdefault.jpg`}
                                          alt={video.title}
                                          loading="lazy"
                                        />
                                        <span className="resp-video-play">
                                          ▶
                                        </span>
                                      </div>
                                ...
                                <div className="resp-steps">
                                  {aud.steps.map((step, i) => (
                                    <div key={i} className="resp-step">
                                      <div className="resp-step-num">
                                        {String(i + 1).padStart(2, "0")}
                                      </div>
                                      <div className="resp-step-title">
                                        {step.title}
                                      </div>
                                  ...
                                  >
                                    <span className="resp-whatsapp-icon">
                                      <img
                                        ...
                                        alt="WhatsApp"
                                        className="resp-whatsapp-icon-img"
                                      />
                                    </span>
                                    <span className="resp-whatsapp-copy">
                                      <small>
                                        {t.responsaveis.stepCta.prompt}
                                      </small>
                                      <strong>
                                        {t.responsaveis.stepCta.talk}
                                      </strong>
                                    </span>
                                  </button>
                                  <p className="resp-whatsapp-note">
                                    {t.responsaveis.stepCta.note}
                                  </p>
                                </div>
                              </div>

                              <div
                                className="resp-group resp-group-community"
                                ref={responsaveisCommunityRef}
                              >
                                <div className="resp-community-card">
                                  <div className="resp-community-top">
                                    <div className="card-kicker light">
                                      {t.responsaveis.community.kicker}
                                    </div>
                                    <div className="community-title">
                                      {t.responsaveis.community.title}
                                    </div>
                                    <p>{t.responsaveis.community.body}</p>
                                  </div>
                                  <div className="resp-community-bottom">
                                    <div className="resp-community-note">
                                      {t.responsaveis.communityNote}
                                    </div>
                                    <button
                                      className="small-action purple discord-cta-button"
                                      onClick={() =>
                                        setModal({
                                          label: "Comunidade no Discord",
                                        })
                    ...
                    {tab === "jornada" && creatorSession ? (
                      ...
                      <ContextRailPanel
                        ...
                        onAction={(card) => {
                          ...
                          if (card.modalLabel)
                            setModal({ label: card.modalLabel });
                        }}
                      />
                    ) : tab === "eco" ? (
                      <ContextRailPanel
                      ...
                      <ContextRailPanel
                        icon={icon}
                        content={railContent.journeyGuest}
                        ui={t.ui}
                        onWhatsApp={openWhatsApp}
                      />
                    )}
        ...
        <div className="modal-backdrop" onClick={() => setModal(null)}>
          <div className="modal-sheet" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-kicker">
              {modal.kind === "section-nav" ? modal.kicker : t.modal.kicker}
            </div>
            <h3 className="modal-title">
              {modal.kind === "section-nav"
                ? modal.title
                : `${t.modal.openPrefix} ${modalName}${t.modal.openSuffix}`}
            </h3>
      ...
      {journeyDrawerOpen && canOpenJourneyDrawer && (
        <div
          className="modal-backdrop journey-drawer-backdrop"
          onClick={() => setJourneyDrawerOpen(false)}
        >
          <div
            className="modal-sheet journey-drawer-sheet"
      ...
      {videoModal && (
        <div
          className="modal-backdrop video-backdrop"
          onClick={() => setVideoModal(null)}
        >
          <div
            className={`video-modal ${videoModal.orientation === "portrait" ? "portrait" : "landscape"}`}
            onClick={(e) => e.stopPropagation()}
          >
            <button
      ...
      {logoutConfirmOpen && (
        ...
        >
          <div
            className="modal-sheet logout-confirm-sheet"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="sheet-handle" />
...
function LoadingOverlay({ loading, hub }) {
  return (
    <div
      className={`loading-overlay ${loading ? "show" : ""} ${hub ? "light" : ""}`}
    >
      <div className="loading-stack">
        <EntryLogos />
        <div className="loading-icons">
          <div className="load-icon">
            {<Icon name="target" color={palette.red} />}
          </div>
          <div className="load-icon">
            {<Icon name="stair" color={palette.blue} />}
          </div>
          <div className="load-icon">
            {<Icon name="shield" color={palette.yellowText} />}
          </div>
          <div className="load-icon">
            {<Icon name="infinity" color={palette.purple} />}
          </div>
        </div>
      </div>
    </div>
...
function EntryLogos() {
  return (
    <div className="entry-logos">
      <img
        className="logo-image entry-pair"
        src="/uploads/logo-expedicao-brasil.png"
        alt="Expedição Roblox Brasil"
      />
      <span className="entry-logos-divider" />
      <img
        className="logo-image entry-pair"
        src="/uploads/logo-expedicao-mexico.svg"
        alt="Expedición Roblox México"
      />
    </div>
  );
}
...
function LogoMark({ color = "#e31837" }) {
  return (
    ...
    >
      <path
        d="M1200 1200H317.193L777.666 734.146L392.32 511.667L203.589 1200H0V0H879.242L418.771 465.854L804.115 688.333L992.847 0H1200V1200Z"
        fill={color}
      />
    </svg>
  );
...
function QuestionPill({ active, disabled, onClick, children }) {
  return (
    <button
      className={`question-pill ${active ? "active" : ""} ${disabled ? "disabled" : ""}`}
      onClick={onClick}
      disabled={disabled}
    >
      {children}
...
function ResultCard({
  ...
  return (
    <div className={`result-card ${theme}`}>
      ...
      {secondaryText && (
        <button className="result-secondary" onClick={onSecondary}>
          {secondaryText} ›
        </button>
      )}
    </div>
  ...
  return (
    <div className="eco-progress">
      <div className="eco-progress-track">
        <div
          className="eco-progress-explored"
      ...
      <div className="eco-progress-label">
        ...
        {pending > 0 && (
          <>
            <span className="eco-progress-sep"> · </span>
            <span className="eco-progress-analyzing">
              {pending} {t.eco.progressAnalyzing}
            </span>
          </>
        )}
      </div>
  ...
  useEffect(() => {
    ...
    const seekToFrame = () => {
      ...
      const safeTarget = Math.min(
        frameAt,
        Math.max((node.duration || frameAt) - 0.2, 0),
      );
      try {
  ...
  return (
    <section className={inline ? "detail-screen-inline" : ""}>
      <button className="detail-back" onClick={onBack}>
        {inline ? labels.close : labels.back}
      </button>
      <div className="detail-head">
        <div>
          {!shouldHideKicker && (
            <div className="detail-kicker" style={{ color: accent }}>
              {kicker}
            </div>
          )}
      ...
      <div className="detail-subline" style={{ color: accent }}>
        {subline}
      </div>
      {loopVideo ? (
        <button
          className="detail-loop"
          onClick={onOpenVideo}
          type="button"
          aria-label={labels.howItWorks}
        >
      ...
      <button
        className={`detail-action ${actionTheme || ""}`}
        onClick={onAction}
      >
        {action}
      </button>
...
function JourneyCard({
  ...
  return (
    <button
      className={`journey-card ${accent} ${open ? "open" : ""}`}
      onClick={onClick}
      aria-expanded={open}
    >
      <div className="journey-head">
        ...
        <span className="journey-head-chevron" aria-hidden="true">
          {open ? "∧" : "∨"}
        </span>
      </div>
      {!compact && (
...
function PromoCard({
  ...
  return (
    <div className={`promo-card ${theme} ${compact ? "compact" : ""}`}>
      ...
      <button className={`promo-button ${theme}`} onClick={onClick}>
        {button}
      </button>
    </div>
  );
    ...
    <div className={`info-rows ${compact ? "compact" : ""}`}>
      {rows.map(([glyph, title, body]) => (
        <div key={title} className="info-row">
          <div className={`info-row-icon ${accent}`}>
            {<RowGlyph glyph={glyph} accent={accent} />}
          </div>
...
function RowGlyph({ glyph, accent }) {
  ...
  if (glyph === "what") {
    return (
      ...
      >
        ...
        <path
          d="M12.7 12.2C12.7 10.1 14.4 8.7 16.4 8.7C18.3 8.7 20 9.9 20 11.9C20 14.2 17.4 14.4 17.1 16.6"
          {...stroke}
        />
  ...
  if (glyph === "who") {
    return (
      ...
      >
        <path
          d="M16 4.5L24 8.3V15.2C24 19.3 20.6 21.9 16 24C11.4 21.9 8 19.3 8 15.2V8.3L16 4.5Z"
          {...stroke}
        />
    ...
    return (
      <div className="rail-context rail-context-editorial">
        <div className="rail-context-head">
          ...
          {content.intro && (
            <p className="rail-context-intro">{content.intro}</p>
          )}
        </div>

        {content.highlight && (
          <section className="rail-editorial-feature">
            <span className="rail-feature-kicker">
              {content.highlight.kicker}
            </span>
              ...
              .map((section) => (
                <section key={section.label} className="rail-editorial-section">
                  <div className="rail-editorial-section-heading">
                    <span className="rail-editorial-section-icon">
                      {icon("target", "#5C6171")}
                    </span>
                    <div className="rail-editorial-section-label">
                      {section.label}
                    </div>
                  </div>
                    ...
                    {section.items.map((item) => (
                      ...
                      >
                        <div className="rail-item-topline">
                          <span
                            className="rail-item-highlight"
                            aria-hidden="true"
                          />
                          <span className="rail-context-card-kicker">
                            {item.kicker}
                          </span>
                          {item.placeholder && (
                            <span className="rail-placeholder-tag">
                              {ui.placeholderTag}
                            </span>
                          )}
                        </div>
                        {renderRailImage(item)}
                        <h4 className="rail-context-card-title">
                          {item.title}
                        </h4>
        ...
        <div className="rail-editorial-end">
          <button
            className="rail-whatsapp-cta"
            aria-label={ui.askMore}
            onClick={onWhatsApp}
          >
            <span className="rail-whatsapp-cta-icon">
              <img
                src="/whatsapp-icon.png"
                alt="WhatsApp"
                className="rail-whatsapp-cta-icon-img"
              />
            </span>
      ...
      <div className="rail-context-grid">
        {content.cards.map((card) => (
          <section key={card.title} className="rail-context-card">
            <div className="rail-context-card-icon">
              {icon(card.icon, "#4B4F64")}
            </div>
...
function Icon({ name, color = "currentColor", large = false }) {
  ...
  if (name === "target") {
    return (
      <svg width="52" height="52" viewBox="0 0 80 80" fill="none">
        <circle cx="40" cy="40" r="32" stroke={color} strokeWidth="1.8" />
        <circle cx="40" cy="40" r="20" stroke={color} strokeWidth="1.8" />
        <circle cx="40" cy="40" r="6" fill={color} />
        <line x1="8" y1="40" x2="20" y2="40" stroke={color} strokeWidth="1.8" />
        <line
          x1="60"
          y1="40"
          x2="72"
          ...
          strokeWidth="1.8"
        />
        <line x1="40" y1="8" x2="40" y2="20" stroke={color} strokeWidth="1.8" />
        <line
          x1="40"
          y1="60"
          x2="40"
  ...
  if (name === "stair") {
    return (
      <svg width="52" height="52" viewBox="0 0 80 80" fill="none">
        <polyline
          points="14,66 14,46 30,46 30,32 46,32 46,18 66,18"
          stroke={color}
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  if (name === "shield") {
    return (
      <svg width="52" height="52" viewBox="0 0 80 80" fill="none">
        <path
          d="M40 10 L66 22 L66 44 C66 58 40 70 40 70 C40 70 14 58 14 44 L14 22 Z"
          stroke={color}
          strokeWidth="2"
          fill="none"
          strokeLinejoin="round"
  ...
  if (name === "classroom") {
    return (
      <svg width="52" height="52" viewBox="0 0 80 80" fill="none">
        ...
        />
        <path
          d="M34 48V55M46 48V55"
          stroke={color}
          strokeWidth="2"
          strokeLinecap="round"
        />
        <path
          d="M24 28H42M24 34H50"
          stroke={color}
          strokeWidth="2"
          strokeLinecap="round"
        />
        <circle cx="55" cy="31" r="4" stroke={color} strokeWidth="2" />
      </svg>
    );
  }
  if (name === "infinity") {
    return (
      <svg width="52" height="52" viewBox="0 0 80 80" fill="none">
        <path
          d="M40 40 C40 40 30 22 18 22 C8 22 8 58 18 58 C30 58 40 40 40 40 C40 40 50 22 62 22 C72 22 72 58 62 58 C50 58 40 40 40 40 Z"
          stroke={color}
          strokeWidth="2"
          fill="none"
        />
  ...
  if (name === "compass") {
    return (
      <svg width="52" height="52" viewBox="0 0 80 80" fill="none">
        <circle cx="40" cy="40" r="27" stroke={color} strokeWidth="2" />
        <path
          d="M49.5 30.5L44.8 44.8L30.5 49.5L35.2 35.2L49.5 30.5Z"
          stroke={color}
          strokeWidth="2"
          strokeLinejoin="round"
        />
        <circle cx="40" cy="40" r="2.8" fill={color} />
      </svg>
    );
  }
  if (name === "pathway") {
    return (
      <svg width="52" height="52" viewBox="0 0 80 80" fill="none">
        <path
          d="M18 61C18 46 30 43 30 30C30 22 25 17 18 14"
          stroke={color}
          strokeWidth="2"
          strokeLinecap="round"
        />
        <path
          d="M62 61C62 46 50 43 50 30C50 22 55 17 62 14"
          stroke={color}
          strokeWidth="2"
          strokeLinecap="round"
        />
        <circle cx="18" cy="14" r="3.5" fill={color} />
        <circle cx="62" cy="14" r="3.5" fill={color} />
        <circle cx="40" cy="61" r="4" stroke={color} strokeWidth="2" />
      </svg>
    );
  }
  if (name === "hex") {
    return (
      <svg width="36" height="36" viewBox="0 0 44 44" fill="none">
        <polygon
          points="22,3 37,12 37,30 22,39 7,30 7,12"
          stroke={color}
          strokeWidth="1.5"
        />
        <circle cx="22" cy="21" r="5" stroke={color} strokeWidth="1.5" />
      </svg>
    );
  }
  if (name === "play") {
    return (
      <svg width="36" height="36" viewBox="0 0 44 44" fill="none">
        ...
        <path d="M17 15 L32 22 L17 29 Z" fill={color} />
      </svg>
    );
  }
  if (name === "arrow") {
    return (
      <svg width="36" height="36" viewBox="0 0 44 44" fill="none">
        <circle cx="22" cy="22" r="18" stroke={color} strokeWidth="1.5" />
        <path
          d="M16 22 L28 22 M23 16 L28 22 L23 28"
          stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  if (name === "logout") {
    return (
      <svg width="28" height="28" viewBox="0 0 44 44" fill="none">
        <path
          d="M18 11.5H13.5C12.4 11.5 11.5 12.4 11.5 13.5V30.5C11.5 31.6 12.4 32.5 13.5 32.5H18"
          stroke={color}
          strokeWidth="1.9"
          strokeLinecap="round"
        />
        <path
          d="M22 14.5L29.5 22L22 29.5"
          stroke={color}
          strokeWidth="1.9"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    return (
      <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
        ...
        <rect
          ...
          opacity="0.45"
        />
        <circle cx="24" cy="37.2" r="1.8" fill={color} />
        <line
          x1="20"
          y1="8.3"
          x2="28"
  ...
  if (name === "doc") {
    return (
      <svg width="30" height="30" viewBox="0 0 44 44" fill="none">
        <path
          d="M14 7.5H25.5L31 13V33.5C31 35.4 29.4 37 27.5 37H14C12.1 37 10.5 35.4 10.5 33.5V11C10.5 9.1 12.1 7.5 14 7.5Z"
          stroke={color}
          strokeWidth="1.9"
          strokeLinejoin="round"
        />
        ...
        />
        <path
          d="M16.5 19H25M16.5 24H25M16.5 29H22.5"
          stroke={color}
          strokeWidth="1.9"
          strokeLinecap="round"
        />
  ...
  if (name === "checklist") {
    return (
      <svg width="30" height="30" viewBox="0 0 44 44" fill="none">
        <path
          d="M16 10.5H30M16 22H30M16 33.5H30"
          stroke={color}
          strokeWidth="1.9"
          strokeLinecap="round"
        />
        <circle cx="11" cy="10.5" r="2.3" stroke={color} strokeWidth="1.9" />
        <path
          d="M8.8 22L10.6 23.8L13.5 20.9"
          stroke={color}
          strokeWidth="1.9"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M8.8 33.5L10.6 35.3L13.5 32.4"
          stroke={color}
          strokeWidth="1.9"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  if (name === "book-open") {
    return (
      <svg width="30" height="30" viewBox="0 0 44 44" fill="none">
        <path
          d="M10.5 12.5C10.5 10.8 11.8 9.5 13.5 9.5H21.5V34C19.9 32.8 18 32.2 16 32.2H13.5C11.8 32.2 10.5 30.9 10.5 29.2V12.5Z"
          stroke={color}
          strokeWidth="1.9"
          strokeLinejoin="round"
        />
        <path
          d="M33.5 12.5C33.5 10.8 32.2 9.5 30.5 9.5H22.5V34C24.1 32.8 26 32.2 28 32.2H30.5C32.2 32.2 33.5 30.9 33.5 29.2V12.5Z"
          stroke={color}
          strokeWidth="1.9"
          strokeLinejoin="round"
        />
        <path
          d="M15 16H19M25 16H29"
          stroke={color}
          strokeWidth="1.9"
          strokeLinecap="round"
        />
  ...
  if (name === "chat") {
    return (
      <svg width="30" height="30" viewBox="0 0 44 44" fill="none">
        <path
          d="M22 8.5C13.99 8.5 7.5 14.44 7.5 21.77C7.5 25.35 9.05 28.61 11.6 31L10.4 36L15.53 34.25C17.49 35.03 19.68 35.45 22 35.45C30.01 35.45 36.5 29.51 36.5 22.18C36.5 14.84 30.01 8.5 22 8.5Z"
          stroke={color}
          strokeWidth="1.9"
          strokeLinejoin="round"
        />
        <path
          d="M16.2 21.7C17.5 24.15 19.82 26.12 22.64 27.05C23.16 27.22 23.7 27.12 24.1 26.78L26.05 25.15C26.42 24.85 26.93 24.77 27.37 24.96L30.18 26.19C30.73 26.44 30.99 27.08 30.77 27.64C30.2 29.09 28.73 29.98 27.18 29.77C20.96 28.92 15.98 24.53 14.31 18.56C13.9 17.09 14.63 15.54 15.96 14.82C16.48 14.53 17.14 14.7 17.46 15.19L19.08 17.7C19.34 18.1 19.37 18.61 19.16 19.03L18.08 21.18C17.87 21.6 17.9 22.12 18.16 22.51"
          stroke={color}
          strokeWidth="1.8"
          strokeLinecap="round"
          strokeLinejoin="round"
