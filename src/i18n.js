...
const pt = {
  ...
  id: {
    ...
    foundUser: "Encontramos este usuário no Roblox",
    isYou: "É você?",
    ...
    notFound: "Usuário não encontrado no Roblox. Verifique o username.",
    noConnection: "Sem conexão. Verifique sua internet e tente novamente.",
    saving: "Salvando...",
    countries: [
...
const en = {
  ...
  id: {
    ...
    continue: "Continue",
    verifying: "Verifying...",
    foundUser: "We found this user on Roblox",
    isYou: "Is this you?",
    noCorrect: "No, fix it",
    yesMe: "Yes, that's me",
    emailLabel: "E-mail",
    ...
    notFound: "User not found on Roblox. Check the username.",
...
const es = {
  ...
  id: {
    ...
    continue: "Continuar",
    verifying: "Verificando...",
    foundUser: "Encontramos este usuario en Roblox",
    isYou: "¿Eres tú?",
    ...
    notFound: "Usuario no encontrado en Roblox. Verifica el username.",
    noConnection: "Sin conexión. Verifica tu internet e intenta de nuevo.",
    saving: "Guardando...",
    countries: [
      { code: "BR", label: "Brasil" },
      { code: "US", label: "Estados Unidos" },
